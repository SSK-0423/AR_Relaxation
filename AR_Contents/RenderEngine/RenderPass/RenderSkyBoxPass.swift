...
class RenderSkyBoxPass : IRenderPass {
    ...
    init(view:MTKView, size:CGSize) {
        ...
        pipelineDescriptor.fragmentFunction = Renderer.library.makeFunction(name: "skyBoxFragment")
    ...
    func draw(view: MTKView, commandBuffer: MTLCommandBuffer, uniforms: SharedUniforms, scene: ARScene) {
        ...
        for geometry in scene.skyBoxGeometries
        {
